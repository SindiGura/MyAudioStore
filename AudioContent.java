...
abstract public class AudioContent
{
  ...
  // Play the content via the audio file
	...
	// ASSIGNMENT 2 BONUS
	public boolean allContains(String target) {

		// checks if the target is within the super class information

		String object = title + id + year + type + length;
		
		if(object.toLowerCase().contains(target.toLowerCase()))
		{
			return true;
		}
		else

...
public class Song extends AudioContent implements Comparable<Song>
{
	...
	public boolean songContains(String target) {

		// checks if the target is within the super class information and the song class
		String object = artist.toString() + composer + genre;

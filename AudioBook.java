...
public class AudioBook extends AudioContent
{
	...
	public boolean audioBookContains(String target) {

		// checks if the target is within the super class information and the audiobook class

		String object = (currentChapter+1) +chapterTitles.get(currentChapter) + chapters.get(currentChapter);
		
		if(object.toLowerCase().contains(target.toLowerCase()) && super.allContains(target))
		{
			return true;
		}
		else
